...
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (2, 1, 1, 'Denver SNS Event', '2022-05-02', 'All current and future Sip n\' Social members are welcome to attend this event!', '2022-03-18', '18:00:00', '20:30:00', 30, 1, 'https://media.istockphoto.com/photos/festival-event-party-with-hipster-people-blurred-background-picture-id613897214?k=20&m=613897214&s=612x612&w=0&h=zRWZF265BWzunfVwI5kCOBIvZSiFyVP_l7a91JGwLNo=');
...
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (4, 2, 2, 'Zero Proof Party - May', '2022-05-15', 'Come out and meetup with other mocktail lovers during this monthly meetup!', '2022-04-15', '18:30:00', '20:30:00', 35, 1, 'https://media.istockphoto.com/vectors/vector-sign-for-mocktails-vector-id1137616794?k=20&m=1137616794&s=612x612&w=0&h=qE3_iEbufu_DtYVklwf8AKG0uQ2-j6-cNKFKUWWYPcE=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (5, 3, 2, 'Mocktail Brew Zoo', '2022-05-08', 'Tame your thirst at this Mocktail Brew Zoo!', '2022-03-24', '19:00:00', '21:00:00', 35, 1, 'https://media.istockphoto.com/photos/crazy-couple-celebrating-new-year-eve-wearing-chicken-and-dinosaur-picture-id1201208190?k=20&m=1201208190&s=612x612&w=0&h=i2fQnfsg4CIyJ-hQksj5d_nrHgJOUSqF0JGVNZr0JeY=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (6, 3, 1, 'Denver Historical Society Meetup', '2022-06-01', 'Establish your spot in history by drinking some classic Mocktails!', '2022-04-17', '17:00:00', '19:30:00', 100, 1, 'https://media.istockphoto.com/vectors/mocktails-vector-id1213422122?k=20&m=1213422122&s=612x612&w=0&h=4ovlEuTZxfMi5ewbZMIq4eRd8ZoUFLEYc9uyZDNeKWY=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (7, 4, 3, 'Old School Mocktail Party', '2022-06-01', 'I am creating this event to invite fellow Mocktail enthusiats to join me to share recipes.', '2022-05-02', '17:30:00', '19:00:00', 45, 1, 'https://media.istockphoto.com/photos/five-cocktails-in-hands-joined-in-celebratory-toast-picture-id1303977605?k=20&m=1303977605&s=612x612&w=0&h=wTyWaQa6mA9QupfqnvoY-sEWdkTWPVy5-w7z9kRALBA=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (8, 4, 3, 'Frozen Mocktail Friday', '2022-05-13', 'We will be blending up some good times at this local meetup!', '2022-03-29', '19:00:00', '21:30:00', 45, 1, 'https://media.istockphoto.com/photos/three-flavors-of-fruit-smoothies-in-glasses-on-white-background-picture-id542184706?k=20&m=542184706&s=612x612&w=0&h=C3oLUfasxLiuOzRlYsWmHnsQS8pcNlTxk8SBHlnyi9A=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (9, 5, 4, 'Shirley Temples and Tapas ', '2022-05-15', 'If you like fruity Mocktails and tapas, this is the event for you!', '2022-04-15', '18:00:00', '20:00:00', 45, 1, 'https://media.istockphoto.com/photos/business-people-meeting-eating-discussion-cuisine-party-concept-picture-id665393236?k=20&m=665393236&s=612x612&w=0&h=PsAcGYgm1kQIdrDdAf0Os4cPQRFyyc8erwdHD5PqcaA=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (10, 5, 5, 'Denver Run and Sip Meetup', '2022-07-15', 'Denver runners, joggers, and powerwalkers join us for some unique non-alcoholic drinks!', '2022-02-15', '19:00:00', '21:00:00', 45, 1, 'https://media.istockphoto.com/photos/friends-dancing-at-a-concert-picture-id1003783908?k=20&m=1003783908&s=612x612&w=0&h=jqukLwRGbG8qWxgEfHjUaJnYfkhcEDLg7zweaT1difI=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (11, 6, 5, 'Over 30 Mocktail Meetup', '2022-05-08', 'This is a meeting for Mocktail lovers over the age of 30 to enjoy the company of like-minded professionals.', '2022-03-24', '18:30:00', '20:30:00', 50, 1, 'https://media.istockphoto.com/photos/funny-grandmother-portraits-80s-style-outfit-trapstar-taking-a-selfie-picture-id1185222054?k=20&m=1185222054&s=612x612&w=0&h=sfIyDd7k7ViT6Op1f1zsw9uHLaqUUULOH4rW5fo9NC0=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (12, 6, 6, 'Class of 2022 Mocktail Meetup', '2022-05-22', 'Come out and celebrate with the class of 2022!', '2022-04-22', '17:00:00', '19:00:00', 50, 1, 'https://media.istockphoto.com/photos/funny-raccoon-in-green-sunglasses-showing-a-rock-gesture-isolated-on-picture-id1154370446?k=20&m=1154370446&s=612x612&w=0&h=2AWvof66ovB87P3b7C_cu0pCZlZhDDFYUFr2KQ2UnwQ=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (13, 2, 7, 'Speed Dating Sip and Social', '2022-06-01', 'Sign up for this event to meet Mocktail lovin singles at this delicious event.', '2022-02-01', '18:00:00', '19:30:00', 100, 1, 'https://media.istockphoto.com/photos/party-people-communication-talking-happiness-concept-picture-id668221242?k=20&m=668221242&s=612x612&w=0&h=XYHyzEnY0GtK6bO7dxXlMuvjHm8yCUk7or91OM_3zVI=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (14, 1, 8, 'Zero Proof Party - June', '2022-06-01', 'Come out and meetup with other mocktail lovers during this monthly meetup!', '2022-05-02', '18:30:00', '21:00:00', 30, 1, 'https://media.istockphoto.com/vectors/vector-sign-for-mocktails-vector-id1137616794?k=20&m=1137616794&s=612x612&w=0&h=qE3_iEbufu_DtYVklwf8AKG0uQ2-j6-cNKFKUWWYPcE=');
INSERT INTO `meetup` (`id`, `address_id`, `user_id`, `title`, `meetup_date`, `description`, `date_created`, `start_time`, `end_time`, `max_attendees`, `active`, `image_url`) VALUES (15, 1, 4, 'Young Professionals Meetup ', '2022-08-01', 'Calling all young professionals in the Denver area who enjoy a fancy smancy Mocktail.', '2021-08-01', '18:00:00', '20:00:00', 30, 1, 'https://media.istockphoto.com/photos/at-the-college-house-costume-party-fun-guy-wearing-space-suit-dances-picture-id1162992197?k=20&m=1162992197&s=612x612&w=0&h=mnBIVth_14weziwTTxGhCIvjmtneIxVvNypgTto7xLg=');
...
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (18, 2, 'Wild Raspberry and Hibiscus Fruit Drink', 4, 'For a burst of freshness try this gorgeous raspberry and hibiscus fruit boost punch.', 1, 'Place 1/2 the raspberries in a bowl. Lightly crush with a fork. Thinly slice remaining peach. Place ice cubes in a 2-litre-capacity jug. Add peach slices and puree, and crushed and whole raspberries. Pour over lemonade. Using a large spoon, stir to combine. Top with mint. Serve.', 'https://img.taste.com.au/qJg7UImR/w720-h480-cfill-q80/taste/2017/02/boost-punch_1980x1320-121118-1.jpg', '2012-04-24 09:00:00');
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (19, 3, 'Watermelon Breeze', 4, 'Rich in antioxidants, this drink makes a refreshing change if you\'re trying to cut back on your alcohol intake during the festive season.', 1, 'Juice two of the oranges. Pour the juice into a large serving jug, add the iced tea and refrigerate until needed. Thinly slice the remaining orange, set aside. Reserve half a punnet of raspberries. Place the remaining 1 1/2 punnets in a bowl and crush with a potato masher or fork.', 'https://img.taste.com.au/XjX4VEKM/w720-h480-cfill-q80/taste/2016/11/watermelon-breeze-77853-1.jpeg', '2017-02-11 09:00:00');
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (20, 15, 'Ginger Punch', 4, 'Everyone will love this non-alcoholic fruit punch this festive season.', 1, 'Place the watermelon and lime cordial in a blender and blend until smooth. Half-fill 4 tall glasses with ice cubes. Divide the watermelon mixture and grapefruit juice among glasses and top up with tonic water. Serve immediately.', 'https://img.taste.com.au/1vZGGy4N/w720-h480-cfill-q80/taste/2016/11/ginger-punch-61213-1.jpeg', '2000-07-19 09:00:00');
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (21, 18, 'Peachy Palmer', 4, 'Fruit infused with notes of mint and strawberries', 1, 'Combine orange juice, apple juice and cordial in a large bowl. Top with mint, strawberries, lemonade and ice. Stir to combine. Serve.', 'https://img.taste.com.au/rTVzbrDp/w720-h480-cfill-q80/taste/2016/11/peachy-mint-iced-tea-110412-1.jpeg', '2019-04-02 09:00:00');
...
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (28, 8, 'Sparkling Tropical Mock-tail', 4, 'A mocktail that will make you feel like you are on an island sunbathing ', 1, 'Using a fork, lightly crush raspberries in a bowl. Transfer to a jug. Add blueberries, strawberries, apple, mint, lemonade and grape juice. Stir to combine. Serve.', 'https://food.fnr.sndimg.com/content/dam/images/food/fullset/2014/8/15/1/KC0305H_Sparkling-Tropical-Mock-tail_s4x3.jpg.rend.hgtvcom.826.620.suffix/1408655622864.jpeg', '2017-06-08 09:00:00');
...
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (40, 2, 'Sunny\'s Grapefruit-Coconut Cooler', 4, 'Mixes grapefruit juice, cream of coconut and agave nectar for a sweet and refreshing sip that is sure to please.', 1, 'Add the sugar cube, lemon juice, apple cider and seltzer to a 6- to 8-ounce Old Fashion glass. Stir to dissolve the sugar. Drop in the ice cube sphere and apple chip. Flame the orange peel by simultaneously bending the peel, skin-side out, and holding a match or lighter near the peel to ignite the spraying orange oil. Rub the peel around the rim of the glass before dropping it in the drink.', 'https://food.fnr.sndimg.com/content/dam/images/food/fullset/2017/12/28/1/KC1512_Grapefruit-Coconut-Cooler_s3x4.jpg.rend.hgtvcom.966.1288.suffix/1514497107272.jpeg', '2019-12-16 09:00:00');
...
INSERT INTO `recipe` (`id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (42, 3, 'Cranberry Spritzer', 4, 'You only need 4 simple ingredients and some ice to make these pretty and oh-so-flavorful non-alcoholic mixed drinks.', 1, 'Fill a 16-ounce copper mug with crushed ice. Add the ginger beer and seltzer. Garnish with the candied ginger and lime wedge.', 'https://food.fnr.sndimg.com/content/dam/images/food/fullset/2008/10/3/0/poinsettia-cocktail_s3x4.jpg.rend.hgtvcom.966.1288.suffix/1382992714870.jpeg', '2015-03-06 09:00:00');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (1, 20, 1, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (10, 70, 1.5, 'kg', '(whole)');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (26, 66, 6, 'ounces', '(unsweetended)');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (26, 74, 3, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (27, 82, 48, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (33, 93, 3, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (33, 56, 1, 'tsp', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (34, 32, 2, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (34, 45, 2, 'wedges', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (36, 2, 2, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (36, 97, 2, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (37, 89, 24, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (38, 18, 6, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (38, 98, 3, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (40, 22, 8, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (40, 91, 2, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (40, 100, 0.5, 'ounce', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (45, 2, 5, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (45, 86, 5, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (45, 3, 3, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (45, 32, 2, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (45, 101, 1, 'tsp', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (45, 61, 5, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (48, 89, 24, 'ounces', '');
...
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (49, 89, 24, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (50, 16, 0.5, 'cup', '(minced)');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (50, 103, 4, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (50, 104, 2, 'ounces', '');
INSERT INTO `recipe_ingredient` (`recipe_id`, `ingredient_id`, `quantity`, `unit`, `instruction`) VALUES (50, 105, 2, 'ounces', '');
