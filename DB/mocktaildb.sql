...
INSERT INTO `recipe` (`id`, `drink_id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (5, 5, 4, 'Strawberry-Ginger Lemonade', 5, '', 1, '', '', '2018-12-27 09:00:00');
INSERT INTO `recipe` (`id`, `drink_id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (6, 6, 4, 'Huckleberry Shrub', 4, '', 1, '', '', '2021-09-26 09:00:00');
INSERT INTO `recipe` (`id`, `drink_id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (7, 7, 3, 'Frozen Apple-Rita', 4, '', 1, '', '', '2021-03-06 09:00:00');
INSERT INTO `recipe` (`id`, `drink_id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (8, 8, 4, 'Tropical Punch', 4, '', 1, '', '', '2013-01-08 09:00:00');
INSERT INTO `recipe` (`id`, `drink_id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (9, 9, 5, 'Cranberry Sangria', 4, '', 1, '', '', '2014-08-09 09:00:00');
INSERT INTO `recipe` (`id`, `drink_id`, `user_id`, `name`, `serving_size`, `description`, `active`, `instructions`, `image_url`, `created_date`) VALUES (10, 10, 2, 'Watermelon Mojitos', 4, '', 1, '', '', '2017-12-14 09:00:00');
