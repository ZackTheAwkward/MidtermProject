...
<head>
<meta charset="UTF-8">
<title>Ready to Add Ingredients?</title>
...
.card-shadow {
	...
	box-shadow: 0 2px 25px 2px rgba(0, 0, 0, 1), 0 2px 50px 2px
		rgba(0, 0, 0, 1), 0 0 100px 3px rgba(0, 0, 0, 0.25);
	height: 1px;
	margin: -1px auto 0;
	width: 80%;
	z-index: -1;
			...
			<div class="row">
				<div class="card-body">
					<div class="col-sm">
						...
						<div class="container">
							<a href="#instructions" class="btn btn-info"
								data-toggle="collapse">Add Ingredient</a>
...
<form action ="prePost.do" method="POST">
...
<input class="form-control-sm" type="text" name="quantity" placeholder="Ingredient Quantity "/>
	<br>
	
<input class="form-control-sm" type="text" name="unit" placeholder="Ingredient Unit "/>
	<br>
	
	
	
<input type= "submit" value= "Would you like to add another Ingredinet?"/>
</form>
