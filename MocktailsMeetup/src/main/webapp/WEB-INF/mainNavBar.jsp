...
<body>
	...
	<nav class="navbar navbar-expand-lg navbar-light bg-light">
		<a class="navbar-brand" href="welcome.do"> <img
			src="https://live.staticflickr.com/65535/52029337243_b29a2f52f1_w.jpg"
			width="auto" height="75px"></a>
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="home.do">ABOUT</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="goLogin.do">MEETUPS</a>
				</li>
				<li class="nav-item"><a class="nav-link" href="goLogin.do">LOG
						IN</a></li>
			...
			<form class="form-inline my-2 my-lg-0" action="search.do">
				<input class="form-control mr-sm-2" name="keyword" type="search"
					placeholder="Sip Sip Hooray" aria-label="Search">
